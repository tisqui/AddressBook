...
public class ContactsSearchListLoader extends AsyncTaskLoader<List<Contact>> {
    ...
    public ContactsSearchListLoader(Context context, Uri uri, ContentResolver contentResolver, String matchText) {
        super(context);
    ...
    public List<Contact> loadInBackground() {
        ...
        String select = ContactsContract.ContactsColumns.CONTACT_NAME + " LIKE '" + mMatchText + "%'";
        mCursor = mContentResolver.query(ContactsContract.URI_TABLE, projection, select, null, null);
        if( mCursor != null){
